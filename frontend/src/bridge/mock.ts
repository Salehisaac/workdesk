...
// ?startapp=session-3 (or ledger-3, project-7, list-7-12, job-7-34) in dev does
// what tapping one of the bot's messages does in the client — read once at
// module load for the same reason initData is: the app
